...
#ifndef INCLUDE_VDA5050_AGVPOSITION_H_
#define INCLUDE_VDA5050_AGVPOSITION_H_
...
struct AGVPosition {
  ...
  inline bool operator!=(const AGVPosition &other) const { return !this->operator==(other); }
};
...
#endif  // INCLUDE_VDA5050_AGVPOSITION_H_
